...
public final class a {
    ...
    private boolean a(String var1, String var2, String var3, String var4, StringBuilder var5) {
        ...
        try {
            ...
            //调起初始化方法  e: 目标类对象   b:context  f:classloader对象   var1： 模块名    var8：machineID   var4:requestID  var19.b()：设备信息json    m:
            Boolean var15 = (Boolean) this.c.invoke(this.e, this.b, this.f, var1, var8, var4, var19.b(), this.m);     // 调起method方法

            // TODO: 2019/4/19  直接调起从dex得到的jar包
//            Boolean var15 = com.kkwinter.thirdsdk.advworkflow.entry.WorkFlowEntry.shareInstance().run(this.b, (ClassLoader) this.f, var1, var8, var4, var19.b(), this.m);
