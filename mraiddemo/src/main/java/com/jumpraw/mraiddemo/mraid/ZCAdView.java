...
import com.jumpraw.mraiddemo.Utils.Background;
import com.jumpraw.mraiddemo.Utils.BrowserDialog;
import com.jumpraw.mraiddemo.Utils.Defaults;
import com.jumpraw.mraiddemo.Utils.ImageRequest;
...
import static com.jumpraw.mraiddemo.Utils.Utils.GOOGLE_PLAY_PKG_NAME;
import static com.jumpraw.mraiddemo.Utils.Utils.dpToPx;
import static com.jumpraw.mraiddemo.Utils.Utils.pxToDp;
...
public class ZCAdView extends ViewGroup {
    ...
    public ZCAdView(Context context) {
        super(context);
        ...
        if (locationManager != null) {
            try {
                ...
                if (provider != null) {
                    ...
                    if (getContext().checkCallingOrSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_DENIED ||
            ...
            browserDialog = new BrowserDialog(getContext(), url, new BrowserDialog.Handler() {
                ...
                public void browserDialogDismissed(BrowserDialog browserDialog) {
                    if (internalBrowserListener != null) {
                        internalBrowserListener.onInternalBrowserDismissed(ZCAdView.this);
                    }
                }
...
//            }
    ...
    private void updateMRAIDLayoutForState(Bridge bridge, Consts.State state) {
        ...
        bridge.setCurrentExposure(percentage, currentWidthDp, currentHeightDp, webViewScreenX, webViewScreenY);
