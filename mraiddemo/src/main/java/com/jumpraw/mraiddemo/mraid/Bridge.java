...
public class Bridge {
    ...
    public void nativeInvoke(String invoke) {
        ...
        String scheme = uri.getScheme().toLowerCase(Locale.US);  //mraid

        if (Consts.Scheme.equals(scheme)) {
            String command = uri.getHost();     //initialize
            String query = uri.getRawQuery();   //？后的参数
            ...
            switch (command) {
                ...
                case Consts.CommandOpen:
                    handler.mraidOpen(this, args.get(Consts.CommandArgUrl));
                    break;
                case Consts.CommandUpdateCurrentPosition:
                    handler.mraidUpdateCurrentPosition(this);
                    break;
                case Consts.CommandExpand:
                    handler.mraidExpand(this, args.get(Consts.CommandArgUrl));
                    break;
                ...
                case Consts.CommandPlayVideo:
                    handler.mraidPlayVideo(this, args.get(Consts.CommandArgUrl));
                    break;
                ...
                case Consts.CommandStorePicture:
                    handler.mraidStorePicture(this, args.get(Consts.CommandArgUrl));
                    break;
            }
        }
    }
