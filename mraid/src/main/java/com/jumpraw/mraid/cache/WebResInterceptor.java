 ...
 * when we call {@link android.webkit.WebView#loadUrl(String)} ,the WebView will try to load all the
 * resource for rendering the html file,
 * just like:css files,js files,images and even the other html files.
 * <p>
 * As for this ,we can intercept the process to do something interesting ,just like caching the
 * resource files
 * <p>
