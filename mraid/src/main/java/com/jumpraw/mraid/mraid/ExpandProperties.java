...
public class ExpandProperties {
    ...
    public static ExpandProperties propertiesFromArgs(Map<String, String> args) {
        ...
        try {
            ...
            properties.setUseCustomClose(Boolean.parseBoolean(args.get(Consts.ExpandPropertiesUseCustomClose)));
        } catch (Exception ex) {
            // TODO: Error handling?
        }
        return properties;
    ...
    public String toString() {
        String useCustomCloseString = useCustomClose ? Consts.True : Consts.False;
