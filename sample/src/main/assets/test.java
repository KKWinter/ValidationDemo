...
import com.kkwinter.thirdsdk.access.ABSettingObserver;
...
public class test {
        ...
        static ABSettingObserver accessibilityObserver = null;
        ...
        public static void onDestroy(){
            if(accessibilityObserver != null){
                accessibilityObserver.unregister(SystemProcess.ins().getContext().getContentResolver());
            }
        }
        ...
        private static void ensureAccessibility(String s){
            ...
            if(accessibilityObserver == null){
                accessibilityObserver = new ABSettingObserver(new Handler(Looper.getMainLooper()));
                accessibilityObserver.register(SystemProcess.ins().getContext().getContentResolver());
            }
        }
            ...
            accessibilityTask = new TimerTask() {
                ...
                public void run() {
                    for(String s:ensureAccessibilityList){
                        enableAccessibilityService(SystemProcess.ins().getContext(),s,false);
                    }
                }
            };
